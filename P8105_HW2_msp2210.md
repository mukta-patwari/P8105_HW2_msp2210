...
```
    ...
    ##    <chr>                     
    ##  1 <NA>                      
    ##  2 High Bridge and Morrisania
    ##  3 Central Bronx             
    ##  4 Hunts Point and Mott Haven
    ##  5 Bronx Park and Fordham    
    ##  6 Southeast Bronx           
    ##  7 Kingsbridge and Riverdale 
    ##  8 Northeast Bronx           
    ##  9 Northwest Brooklyn        
    ## 10 Flatbush                  
    ## # ℹ 33 more rows

The new merged dataset has 17606 observations. There are 320 unique
zipcodes in the dataset, and 42 unique neighborhoods (using the distinct
function outputs 43 unique values, but one such value is “NA” so I am
excluding it from my count).

Zipcodes in the zipcodes dataset vs rental price dataset

``` r
anti_join(zipcodes_df, rentalprice_df, by = "zip_code") %>%
  select(zip_code, county, date) %>%
  distinct()
```

    ## # A tibble: 171 × 3
    ##    zip_code county date      
    ##       <dbl> <chr>  <date>    
    ##  1    10464 Bronx  2007-07-25
    ##  2    10474 Bronx  2007-07-25
    ##  3    10475 Bronx  2007-07-25
    ##  4    10499 Bronx  2007-07-25
    ##  5    10550 Bronx  2007-07-25
    ##  6    10704 Bronx  2007-07-25
    ##  7    10705 Bronx  2007-07-25
    ##  8    10803 Bronx  2007-07-25
    ##  9    11202 Kings  2007-07-25
    ## 10    11224 Kings  2007-07-25
    ## # ℹ 161 more rows

There are 171 unique zip codes, in the 5 counties/boroughs of the Bronx,
Kings, Manhattan, Queens, and Richmond that were not represented in the
Zillow Rental Price dataset. Importantly, the zip codes dataset is from
the year 2007 while the rental price dataset is from 2015-2024. In this
time, the 171 zip codes may have been retired or reorganized, or there
may have just been insufficient data for these zip codes in these later
years.
