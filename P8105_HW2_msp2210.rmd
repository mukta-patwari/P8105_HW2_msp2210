...
The new merged dataset has `r nrow(zillow_df)` observations. There are 320 unique zipcodes in the dataset, and 42 unique neighborhoods (using the distinct function outputs 43 unique values, but one such value is "NA" so I am excluding it from my count). 
...
There are 171 unique zip codes, in the 5 counties/boroughs of the Bronx, Kings, Manhattan, Queens, and Richmond that were not represented in the Zillow Rental Price dataset. Importantly, the zip codes dataset is from the year 2007 while the rental price dataset is from 2015-2024. In this time, the 171 zip codes may have been retired or reorganized, or there may have just been insufficient data for these zip codes in these later years. 