...
zipcodes_df$zip_code[duplicated(zipcodes_df$zip_code)]

# 10463 is in the Bronx
# 11201 is in Kings
# remove the observations where this shows up in New York County
...
The new merged dataset has `r nrow(zillow_df)` observations. There are 149 unique zipcodes in the dataset, and 43 unique neighborhoods.There are 171 unique zip codes, in the 5 counties/boroughs of the Bronx, Kings, Manhattan, Queens, and Richmond that were not represented in the Zillow Rental Price dataset. [Examples for why these are not included in the rentalprice_df]